    ...
    public class ApplicationResponseCode
    {
        ...
        private static List<ErrorMessage> ErrorMessageDataBank()
        {
            ...
            ;
                ...
                var data703 = new ErrorMessage
                {
                    Code = "703",
                    Name = "the lga supplied does not exist"
                };
                listData.Add(data703);

                var data704 = new ErrorMessage
                {
                    Code = "704",
                    Name = "the lga supplied does not exist in the state, kindly check your lga"
                };
                listData.Add(data704);
